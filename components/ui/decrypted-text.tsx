...
export default function DecryptedText({
  ...
  // Auto-repeat animation every 3 seconds
  useEffect(() => {
    if (animateOn === "view" && hasStarted) {
      ...
      // Set up repeating after a small delay
      const timeout = setTimeout(startRepeating, 1500)
